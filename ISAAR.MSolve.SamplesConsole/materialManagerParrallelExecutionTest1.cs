...
{
    public static class materialManagerParrallelExecutionTest1
    {
        ...
        public static void TestMaterialUpdateOnly(int numProcesses)
        {
            ...
            IContinuumMaterial3DDefGrad material1;

            IContinuumMaterial3DDefGrad[] modelMaterials =new IContinuumMaterial3DDefGrad[9];

            //double[][] s11stresses = new double[2][];
            ...
            if (procs.IsMasterProcess)
            {
                material1 = new RemoteMaterial(materialManager);
                modelMaterials = new IContinuumMaterial3DDefGrad[9];
                for (int i1 = 0; i1 < modelMaterials.Length; i1++)
                {
                    modelMaterials[i1] = (IContinuumMaterial3DDefGrad)material1.Clone();
                }
            ...
            if (procs.IsMasterProcess)
            {
                for (int i1 = 0; i1 < modelMaterials.Length; i1++)
                {
                    modelMaterials[i1].UpdateMaterial(new double[] { 1.05, 1, 1, 0, 0, 0, 0, 0, 0 });
                }
            ...
            if (procs.IsMasterProcess)
            {
                //s11stresses[0] = new double[]
                //    {modelMaterials[0].Stresses[0],modelMaterials[1].Stresses[0],modelMaterials[2].Stresses[0]};
                //Console.WriteLine($"s11stresses[0][0]=" + s11stresses[0][0] + " s11stresses[0][1]=" + s11stresses[0][1]+ " s11stresses[0][2]=" + s11stresses[0][2]);
                for (int i1 = 0; i1 < modelMaterials.Length; i1++)
                {
                    Console.WriteLine($"state 0 material " + i1 + " =" + modelMaterials[i1].Stresses[0]);
            ...
            if (procs.IsMasterProcess)
            {
                for (int i1 = 0; i1 < modelMaterials.Length; i1++)
                {
                    modelMaterials[i1].UpdateMaterial(new double[] { 1.10, 1, 1, 0, 0, 0, 0, 0, 0 });
                }
