...
namespace ISAAR.MSolve.Tests.FEMpartB.SeparationBenchmarks2
{
    public class OneRveExampleMpiTest // palio: "SeparateCodeCheckingClass4 "
    {
        ...
        [Fact]
        public static /*(double[], double[], double[,], IVector, IVector)*/ void Check_Graphene_rve_serialPRINT_for_matlab_Gsi_implementationPrintHomogenisation() //palio "Check_Graphene_rve_Obje_Integration()"
        {
            //ORIGINAL: onerveexamplempiTest.Check_Graphene_rve_serial();
            #region rve builder parameters and example choice
            CnstValues.exampleNo = 66;
            CnstValues.isInputInCode_forRVE = false;
            CnstValues.useInput_forRVE = true; //Panta prin thn getRveModelAndBoundaryNodes
            CnstValues.printNRstiffnessMatrices = true;
            ...
            CnstValues.analyzerNRIter = 0;
            CnstValues.stressIncrNo = 0;
            CnstValues.printHomogenizationRHSsAndStiffnessmat1 = true;
            CnstValues.analyzerInfoIsSolutionForNRiters = false;
            var constitutive = microstructure2Serial.ConstitutiveMatrix;
            //microstructure2Serial.UpdateMaterial(new double[9] { /*1.10*/ 1.01, 1, 1, 0, 0, 0, 0, 0, 0 });
            //microstructure2Serial.SaveState();
            //microstructure2Serial.UpdateMaterial(new double[9] { /*1.10*/ 1.03, 1, 1, 0, 0, 0, 0, 0, 0 });
