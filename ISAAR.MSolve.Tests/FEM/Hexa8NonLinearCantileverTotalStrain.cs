...
{
    public static class Hexa8NonLinearCantileverTotalStrain
    {
    ...
    { 0,7.975944951878896600e-02 }, {11,-6.715222916021290600e-02 }, {23,-1.400036636464831200e-01 }, {35,-2.194844883932760600e-01 }, {47,-2.998045884933974200e-01 }};
        ...
        private static void BuildCantileverModel(Model model, double load_value)
        {
            ...
            var material1 = new ElasticMaterial3DTotalStrain(0.3, 1353000);
            ...
            // orismos elements 
            Element e1;
            int subdomainID = Hexa8NonLinearCantileverTotalStrain.subdomainID;
            for (int nElement = 0; nElement < elementData.GetLength(0); nElement++)
            {
                e1 = new Element()
                {
                    ID = nElement + 1,
                    ElementType = new Hexa8NonLinearTotalStrain(material1, GaussLegendre3D.GetQuadratureWithOrder(3, 3, 3)) // dixws to e. exoume sfalma enw sto beambuilding oxi//edw kaleitai me ena orisma to Hexa8                    
                };
                for (int j = 0; j < 8; j++)
                {
