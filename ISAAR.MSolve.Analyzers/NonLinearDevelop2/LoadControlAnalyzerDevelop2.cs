...
{
    public class LoadControlAnalyzerDevelop2 : IChildAnalyzer //: NonLinearAnalyzerBaseDevelop2
    {



        private LoadControlAnalyzerDevelop2(IModel model, ISolver solver, INonLinearProvider provider,
        ...
        public class Builder
        {
            ...
            public LoadControlAnalyzerDevelop2 Build()
            {
                return new LoadControlAnalyzerDevelop2(model, solver, provider, SubdomainUpdaters,
            ...
            private IReadOnlyDictionary<int, INonLinearSubdomainUpdaterDevelop> CreateDefaultSubdomainUpdaters()
            {
                ...
                {
                    subdomainUpdaters[subdomain.ID] = new NonLinearSubdomainUpdaterDevelop2(subdomain);
