...
namespace ISAAR.MSolve.FEM.Elements
{
    public class Hexa8Fixed : IStructuralFiniteElement, IEmbeddedHostElement
    {
        ...
        public Hexa8Fixed(IContinuumMaterial3D material)
        {
            ...
            strainsVec = new double[materialsAtGaussPoints.Length][];
            strainsVecLastConverged = new double[materialsAtGaussPoints.Length][];
            for (int gpoint = 0; gpoint < materialsAtGaussPoints.Length; gpoint++)
            {
