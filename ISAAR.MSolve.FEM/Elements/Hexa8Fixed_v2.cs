...
{
    public class Hexa8Fixed_v2 : IStructuralFiniteElement, IEmbeddedHostElement
    {
        ...
        public Hexa8Fixed_v2(IContinuumMaterial3D material, IElementDofEnumerator dofEnumerator)
            : this(material)
        {
